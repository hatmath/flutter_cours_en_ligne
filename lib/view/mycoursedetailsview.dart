...
class MyCourseDetailsViewState extends State<MyCourseDetailsView>
  ...
  void dispose() {
    ...
    _fadeController
        .dispose(); // Toujours disposer les controllers quand ils ne sont plus utilisés
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    ...
    // Si MyConfig.currentCourse n'est pas vide, ajouter le bouton à la liste
          ...
          child: ElevatedButton(
            onPressed: () {
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) =>
                      VideoPlayerScreen(videoPath: 'assets/videos/video.mp4'),
                ),
              );
            },
